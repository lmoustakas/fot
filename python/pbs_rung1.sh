...
#
export PBS_O_WORKDIR=/aurora_nobackup/lenssim/romerowo/fot/outputs/tdc1_rung1_out

# Set your input directory (optional)
#
export INPUT_DIR=/aurora_nobackup/lenssim/romerowo/fot/python/inputs/rung1
