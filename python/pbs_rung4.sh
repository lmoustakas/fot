...
#
export PBS_O_WORKDIR=/aurora_nobackup/lenssim/romerowo/fot/outputs/tdc1_rung4_out

# Set your input directory (optional)
#
export INPUT_DIR=/aurora_nobackup/lenssim/romerowo/fot/python/inputs/rung4
...
#
/aurora_nobackup/lenssim/romerowo/fot/python/run_python_command.py $INPUT_DIR/input.$PBS_ARRAY_INDEX > output.$PBS_ARRAY_INDEX
#
